...
1.  The code presented generates panels and analyses presented in the accompanying paper (Godfree & Knerr, Methods in Ecology & Evolution, in press). To use it please clone the repository and then open the project pannotator_analyse.Rproj in RStudio. Please open the pannotator_examples.qmd file (quarto must be installed). All data files required are provided in the Data_files folder.\
